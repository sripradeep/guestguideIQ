...
**Status:** genuinely unchosen. Every functional-design artifact is deliberately
framework-neutral because of it.
...
**Status:** narrowed but not settled. `u3-foundation`'s Q1 = A decided the store
